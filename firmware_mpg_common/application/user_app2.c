...
{
  static u32  u32CorrectTimesCounter = 0;
  static u8  u8MessageForDetectedTimes[] = "'John' has been detected: ";
  static u32  u32BuzzCounter = 0; 
  ...
  if(G_bUserAppCharacterCorrectFlag)
  {
   ...
   /*show counter that my name has been detected*/
    DebugLineFeed();
    DebugPrintf(u8MessageForDetectedTimes);
    DebugPrintNumber(u32CorrectTimesCounter);
    DebugLineFeed();
    
    /*initialize LED and the BUZZER*/
